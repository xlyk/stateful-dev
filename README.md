...
See [`docs/system-integration-lite.md`](docs/system-integration-lite.md) for the quick mental model. See [`docs/system-integration.md`](docs/system-integration.md) for the detailed reference tying `stateful-dev`, Poseidon, Hermes cron, and the Hermes plugin together. See [`docs/cron-gate-contract.md`](docs/cron-gate-contract.md) for the scheduler contract and [`docs/cron-gate.md`](docs/cron-gate.md) for the runbook.
...
- [`docs/system-integration-lite.md`](docs/system-integration-lite.md) — quick mental model for stateful-dev, Poseidon, Hermes cron, and the plugin
- [`docs/system-integration.md`](docs/system-integration.md) — detailed integration reference for stateful-dev, Poseidon, Hermes cron, and the plugin
